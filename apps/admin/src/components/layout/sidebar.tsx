...
const NAV_ITEMS: NavItem[] = [
  { href: "/dashboard", label: "Tổng quan", epic: "E5.2", permissions: [Permissions.ReportView], icon: LayoutDashboard },
  ...
  { href: "/media", label: "Thư viện Media", epic: "E5.14", permissions: [Permissions.FileManage], icon: HardDrive },
